...
samples=("HRR1795849" "HRR1795850" "HRR1795851" "HRR1795852" "HRR1795853" "HRR1795854" "HRR1795855" "HRR1795856")
...
for sample in "${samples[@]}"; do
    ...
    samtools index to_scp/${sample}/${sample}_possorted_genome_X.sorted.bam

    samtools index to_scp/${sample}/${sample}_s162p_subset.bam
